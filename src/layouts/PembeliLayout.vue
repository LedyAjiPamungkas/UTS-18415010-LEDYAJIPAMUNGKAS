            ...
            <div class="row no-wrap q-pa-lg">
              <div class="column">
                ...
                <div class="items-center">
                  <div class="text-bold items-center">CUSTOMER</div>
                  <div>Eki Adi Pratama</div>
                </div>
              </div>
              ...
              <div class="column items-center">
                <q-btn flat round dense>
                  <q-avatar size="70px">
                    <img src="/statics/cowboy-gorilla-vaper_148096-52.jpg">
                  </q-avatar>
                </q-btn>
    ...
    >
      <q-scroll-area class="fit">
        <q-list>
          ...
          <q-item class="justify-center text-center q-mb-md q-pt-md">
            <div>
              <q-avatar size="100px" class="q-mb-md">
                <img src="/statics/cowboy-gorilla-vaper_148096-52.jpg" alt="">
              </q-avatar>
          ...
          <q-item clickable active-class="active" exact v-ripple to="/pembeli/mod">
          ...
          <q-item clickable active-class="active" exact v-ripple to="/pembeli/rda">
            <q-item-section avatar>
              <q-icon name="table_chart" />
            </q-item-section>
            <q-item-section>
          ...
          <q-item clickable active-class="active" exact v-ripple to="/pembeli/rdta">
            <q-item-section avatar>
              <q-icon name="table_chart" />
            </q-item-section>
            <q-item-section>
